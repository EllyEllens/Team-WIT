...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['firstName'])) {
    ...
    $sql = "INSERT INTO student (voor_naam, naam, geboorte, telefoon, email, profiel, geslacht, wachtwoord) 
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        echo "Fout bij toevoegen student: " . $conn->error;
    }
}

// Studenten ophalen uit de database
$sql = "SELECT id, voor_naam, naam, geboorte, telefoon, email, geslacht FROM student";
        ...
        <div class="container-wrapper">
                ...
                <table id="studentTable">
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "<tr><td colspan='7'>Geen studenten gevonden</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
            ...
            <div class="form-container">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn">Voeg Student Toe</button>
                </form>
            </div>
        </div>
